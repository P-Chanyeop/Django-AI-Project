...
from .views import base_views, question_views, answer_views, comment_views, vote_views, analyze

# urls.py 파일은 /pybo 경로의 페이지 요청이 발생하면 가장 먼저 호출되는 파일로 URL과 뷰 함수 간의 매핑을 정의한다.
...
urlpatterns = [
    ...
    # homepage.py
    path('homepage/', question_views.homepage, name='homepage'),
    # path('homepage/analyze/', base_views.analyze, name='analyze'),
]